...
# Recuerda mostrar el diagrama y realizar una breve descripción del mismo. (En el PDF)
...
VALUES ('b-9999');	#Primero se ha de crear la empresa, ya que no existe en la tabla company, y ambas tablas (transaction y company) están unidas por company_id

INSERT INTO transaction (transaction_id, credit_card_id, company_id, user_id, lat, longitude, amount, declined)
VALUES ('108B1D1D-5B23-A76C-55EF-C568E49A99DD', 'CcU-9999', 'b-9999', 9999, 829.999, -117.999, 111.11, 0);	#Finalmente se puede añadir la nueva transacción
...
-- Nivel 2
# Ejercicio 1: Elimina de la tabla transacción el registro con ID 02C6201E-D90A-1859-B4EE-88D2986D3B02 de la base de datos.
